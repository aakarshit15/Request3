  ...
  return (
    <>
      {!allScores[team] ? (
        ...
        <>
          <div className="bg-container bg-opacity-90">
            <div className="team-header flex md:flex-row justify-center sm:justify-between mx-auto w-11/12 md:w-4/5 border-b-4 border-b-[#F4F6F595]">
              <h1 className="team-name text-4xl md:text-5xl font-bold text-center py-4 tracking-widest flex flex-wrap justify-center">
                <span className="team-fname sm:text-2xl lg:text-5xl bg-red-700 inline-flex justify-center font-MarvelFont text-white">
                  {team.split('_')[0].toUpperCase()}
                </span>
                &nbsp;
                <span className="team-lname sm:text-2xl lg:text-5xl inline-flex justify-center font-MarvelFont text-[#838383] border-t-4 border-b-4 border-[#838383]">
